...
# import from folders
from app import *
from components import sidebar, dashboards, extratos, extratos_investimentos
...
list_investimentos = pd.read_csv('df_cat_investimentos.csv', index_col=0)
...
def render_page_content(pathname):
    ...
    if pathname == "/extratos_investimentos":
        return extratos_investimentos.layout
